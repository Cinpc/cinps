...
const navigationMenuTriggerStyle = cva(
  'group/navigation-menu-trigger inline-flex w-max items-center justify-center rounded-lg p-3.75 text-base  font-normal transition-all outline-none hover:text-blue focus:text-blue focus-visible:ring-3 focus-visible:ring-blue/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:text-blue data-popup-open:hover:text-blue data-open:text-blue data-open:hover:text-blue data-open:focus:text-blue'
);
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      {...props}
    >
      <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-black/10 shadow-md" />
    </NavigationMenuPrimitive.Icon>
  );
}
