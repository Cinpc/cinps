...
export default function HomeHaveCalls() {
  return (
        ...
        <div className="grid items-center lg:grid-cols-[0.87273fr_1fr] gap-y-6 gap-x-21">
          ...
          <div>
            <Title variant="purple" className="mb-4 leading-[1.4]">
              Have Calls Your Team Shouldn&apos;t Be Handling?
            </Title>
            <Description className="mb-8" size="17">
              Show us what currently lands on your team&apos;s desk. We can
              identify which customer operations make sense to move to Cinpc.
            </Description>
